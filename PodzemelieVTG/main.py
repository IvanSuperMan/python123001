...
def start_level_1(message):
    ...
    bot.send_photo(message.chat.id, open('Кощей.jpg', 'rb'))
...
def start_level_2(message):
    ...
    bot.send_photo(message.chat.id, open('Леший.jpg', 'rb'))
    msg = bot.send_message(message.chat.id,
...
def start_level_3(message):
    ...
    bot.send_photo(message.chat.id, open('Ведьма.jpg', 'rb'))
...
def check_number(message):
    ...
    if guess == user_data['target_number']:
        ...
        bot.send_photo(message.chat.id, open('Сундук.jpg', 'rb'))
